...
// * Header Page eg. logo , search bar , login button
    ...
    <div>
      <header className="flex justify-between">
        ...
        <div className="flex gap-2 border border-gray-300 rounded-full py-2 px-4 shadow-md shadow-gray-200">
          <div className="cursor-pointer">Any where</div>
          <div className="border-l border-gray-300"></div>
          <div className="cursor-pointer">Any Week</div>
          <div className="border-l border-gray-300"></div>
          <div className="cursor-pointer">Add Guest</div>
        ...
        <Link 
          ...
          className="flex items-center gap-2 border border-gray-300 rounded-full py-2 px-4 shadow-md shadow-gray-200"
        >
          {/* three line */}
          <svg
            xmlns="http://www.w3.org/2000/svg"
